...
public class DaySignOn {
  ...
  public DaySignOn(String userEmail){
	    date = new Date();
	    dateTable = "avail"+ date.getMonth();
	    Calendar cal = Calendar.getInstance();
	    cal.setTime(date);	 
	    dal.get(Calendar.MONTH);
  }

  /**
   * A convenience constructor
   **/
  public DaySignOn(String book, String content) {
    this();
    if( book != null ) {
   ...
   **/
  public DaySignOn(String book, String content, String id, String email) {
    this(book, content);
    userEmail = email;
    author_id = id;
  }
